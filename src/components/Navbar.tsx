...
const navLinks: NavLink[] = [
  {
    ...
    sections: [
      ...
      { label: 'Our Mission', hash: '#premium-kernel' },
      { label: 'Solutions', hash: '#products' },
      { label: 'Gallery', hash: '#gallery' },
      { label: 'About FV+', hash: '#sequence' },
    ],
  },
  {
    label: 'ANVAYA™',
    ...
    sections: [
      { label: 'Overview', hash: '#hero' },
      { label: 'Why ANVAYA™', hash: '#benefits' },
      { label: 'Our Vision', hash: '#nutrition' },
    ],
  },
  {
    label: 'IRIS',
    ...
    sections: [
      { label: 'Overview', hash: '#hero' },
      { label: 'The Challenge', hash: '#problem' },
      { label: 'Market Insights', hash: '#wastage' },
      { label: 'Opportunity', hash: '#market-size' },
      { label: 'Inside IRIS', hash: '#inside-iris' },
      { label: 'Why IRIS', hash: '#stats' },
      { label: 'Applications', hash: '#applications' },
      { label: 'Technology', hash: '#tech' },
      { label: 'Market Presence', hash: '#partners' },
    ],
  },
];
