...
export default function UnicornHero() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#061206]">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden z-0">
        <iframe
          ...
          style={{
            ...
            left: 0,
            width: '100%',
            height: 'calc(100% + 60px)', // Pushes the bottom watermark out of the visible screen bounds
            border: 'none',
            outline: 'none',
            boxShadow: 'none',
          }}
      ...
      {/* Dark overlay to match theme if needed or styling */}
      <div className="absolute inset-0 pointer-events-none z-10 bg-gradient-to-b from-black/20 via-transparent to-black/30" />

      {/* Hero Headline Content */}
      <div className="absolute inset-0 flex items-center justify-center text-center px-5 md:px-10 z-20 pointer-events-none">
        {mounted && (
          <motion.div
